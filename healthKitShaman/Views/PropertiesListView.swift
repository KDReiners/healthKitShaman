...
struct PropertiesListView <T>: View where T: GenericViewModel {
    ...
    var body: some View {
        List {
            ...
            Divider()
            DataNavigatorView(masterObject: detailObject, detailObject: LogTimeCapsules(resolution: 3600, quantityType: (detailObject.items[recordIndex] as! NSManagedObject).value(forKey: "hk_quantitytype") as! String), recordIndex: recordIndex, childrenRelationKey: "hk_quantitytype")
